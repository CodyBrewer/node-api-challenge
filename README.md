...
- [x] Describe Middleware?  
    ...
    Methods which are functons that have access to the request object (req), the response object (res) and let us evaluate the res and req objects and modify them before the final 
    compact.

- [x] Describe a Resource?

  A resourece is anything that's important enough to be referenced as a thing in itself.
